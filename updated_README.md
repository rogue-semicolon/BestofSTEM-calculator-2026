...
- See pricing update live at the bottom of the page as they select (tier breaks at 1 / 2–4 / 5+ entries)
...
## 2026 Award categories (50 total)

Categories are organized into 6 groups in the calculator:

| Group | Count |
|-------|-------|
| Best of AI — New for 2026 | 9 |
| Educator Favorites | 7 |
| Best of STEM | 13 |
| Career & Technical Education | 7 |
| Trailblazer | 9 |
| Bridging the Gap | 5 |

To update categories, find `const CATEGORIES` in `index.html` and edit the object. Category names and groupings should match bestofstemawards.com/2026-categories-for-educators-pick-stem-education-awards/.
